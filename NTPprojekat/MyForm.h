...
namespace NTPprojekat {
	...
	private: System::Windows::Forms::Label^ greskaLabel;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->greskaLabel = (gcnew System::Windows::Forms::Label());
			...
			this->imeLabel->Font = (gcnew System::Drawing::Font(L"Montserrat", 12, System::Drawing::FontStyle::Bold));
			this->imeLabel->Location = System::Drawing::Point(173, 32);
			this->imeLabel->Name = L"imeLabel";
			this->imeLabel->Size = System::Drawing::Size(42, 22);
			...
			this->imeInput->Size = System::Drawing::Size(155, 27);
			...
			this->prezimeInput->Size = System::Drawing::Size(154, 27);
			...
			this->prezimeLabel->Size = System::Drawing::Size(80, 22);
			...
			this->adresaInput->Size = System::Drawing::Size(245, 27);
			...
			this->adresaLabel->Size = System::Drawing::Size(70, 22);
			...
			this->mjestoInput->Size = System::Drawing::Size(155, 27);
			...
			this->mjestoLabel->Size = System::Drawing::Size(66, 22);
			...
			this->godinaRodenjaInput->Size = System::Drawing::Size(154, 27);
			...
			this->godinaRodjenjaLabel->Size = System::Drawing::Size(140, 22);
			...
			this->imeOcaInput->Size = System::Drawing::Size(155, 27);
			...
			this->imeOcaLabel->Size = System::Drawing::Size(77, 22);
			...
			this->postanskiBrInput->Size = System::Drawing::Size(100, 27);
			...
			this->postanskiLabel->Size = System::Drawing::Size(132, 22);
			...
			this->licniPodaciBox->Font = (gcnew System::Drawing::Font(L"Montserrat", 12, System::Drawing::FontStyle::Bold));
			...
			this->podOPrebivalistuBox->Font = (gcnew System::Drawing::Font(L"Montserrat", 12, System::Drawing::FontStyle::Bold));
			...
			this->brojClanovaLabel->Size = System::Drawing::Size(116, 22);
			...
			this->brClanovaInput->Size = System::Drawing::Size(100, 27);
			...
			this->obracunskiPeriodBox->Font = (gcnew System::Drawing::Font(L"Montserrat", 12, System::Drawing::FontStyle::Bold));
			...
			this->obracunskiPeriodBox->Text = L"Obračunski period";
			// 
			// pictureBox5
			// 
			...
			this->drugiDatumInput->Size = System::Drawing::Size(176, 27);
			...
			this->doLabel->Size = System::Drawing::Size(31, 22);
			...
			this->prviDatumInput->Size = System::Drawing::Size(176, 27);
			this->prviDatumInput->TabIndex = 32;
			// 
			// odLabel
			// 
			this->odLabel->AutoSize = true;
			this->odLabel->Location = System::Drawing::Point(185, 59);
			this->odLabel->Name = L"odLabel";
			this->odLabel->Size = System::Drawing::Size(31, 22);
			...
			this->stanjeVodeBox->Font = (gcnew System::Drawing::Font(L"Montserrat", 12, System::Drawing::FontStyle::Bold));
			...
			this->novoStanjeInput->Size = System::Drawing::Size(88, 27);
			...
			this->staroStanjeInput->Size = System::Drawing::Size(88, 27);
			...
			this->novoStanjeLabel->Size = System::Drawing::Size(111, 22);
			...
			this->staroStanjeLabel->Size = System::Drawing::Size(113, 22);
			...
			this->ispisiRacunBtn->Font = (gcnew System::Drawing::Font(L"Montserrat", 12, System::Drawing::FontStyle::Bold));
			...
			this->OcistiPoljaBtn->Font = (gcnew System::Drawing::Font(L"Montserrat", 12, System::Drawing::FontStyle::Bold));
			...
			this->sacuvajRacunBtn->Font = (gcnew System::Drawing::Font(L"Montserrat", 12, System::Drawing::FontStyle::Bold));
			...
			this->sacuvajRacunBtn->Location = System::Drawing::Point(12, 393);
			this->sacuvajRacunBtn->Name = L"sacuvajRacunBtn";
			this->sacuvajRacunBtn->Size = System::Drawing::Size(197, 50);
			...
			this->izlazBtn->Font = (gcnew System::Drawing::Font(L"Montserrat", 12, System::Drawing::FontStyle::Bold));
			...
			this->izlazBtn->Size = System::Drawing::Size(206, 50);
			...
			this->noviRacunBtn->Font = (gcnew System::Drawing::Font(L"Montserrat", 12, System::Drawing::FontStyle::Bold));
			...
			this->noviRacunBtn->Location = System::Drawing::Point(12, 329);
			this->noviRacunBtn->Name = L"noviRacunBtn";
			this->noviRacunBtn->Size = System::Drawing::Size(197, 50);
			...
			this->traziRacunBtn->Font = (gcnew System::Drawing::Font(L"Montserrat", 12, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
			...
			this->traziRacunBtn->Location = System::Drawing::Point(12, 273);
			this->traziRacunBtn->Name = L"traziRacunBtn";
			this->traziRacunBtn->Size = System::Drawing::Size(197, 50);
			...
			this->label13->Font = (gcnew System::Drawing::Font(L"Montserrat", 14.25F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label13->ForeColor = System::Drawing::SystemColors::Control;
			this->label13->Location = System::Drawing::Point(229, 9);
			this->label13->Name = L"label13";
			this->label13->Size = System::Drawing::Size(546, 26);
			...
			this->traziRacunBox->Font = (gcnew System::Drawing::Font(L"Montserrat", 12, System::Drawing::FontStyle::Bold));
			this->traziRacunBox->ForeColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(64)), static_cast<System::Int32>(static_cast<System::Byte>(64)),
				static_cast<System::Int32>(static_cast<System::Byte>(64)));
			this->traziRacunBox->Location = System::Drawing::Point(297, 320);
			...
			// pregledRacuna
			// 
			this->pregledRacuna->BackColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(64)), static_cast<System::Int32>(static_cast<System::Byte>(64)),
				static_cast<System::Int32>(static_cast<System::Byte>(64)));
			this->pregledRacuna->FlatStyle = System::Windows::Forms::FlatStyle::Flat;
			this->pregledRacuna->ForeColor = System::Drawing::SystemColors::Control;
			this->pregledRacuna->Image = (cli::safe_cast<System::Drawing::Image^>(resources->GetObject(L"pregledRacuna.Image")));
			this->pregledRacuna->ImageAlign = System::Drawing::ContentAlignment::MiddleLeft;
			this->pregledRacuna->Location = System::Drawing::Point(590, 38);
			this->pregledRacuna->Margin = System::Windows::Forms::Padding(2);
			this->pregledRacuna->Name = L"pregledRacuna";
			this->pregledRacuna->Size = System::Drawing::Size(194, 51);
			this->pregledRacuna->TabIndex = 24;
			this->pregledRacuna->Text = L"pregled računa";
			this->pregledRacuna->TextAlign = System::Drawing::ContentAlignment::MiddleRight;
			this->pregledRacuna->UseVisualStyleBackColor = false;
			this->pregledRacuna->Click += gcnew System::EventHandler(this, &MyForm::pregledRacuna_Click);
			// 
			// pictureBox2
			// 
			...
			this->trazeniRacunInput->Size = System::Drawing::Size(155, 27);
			this->trazeniRacunInput->TabIndex = 11;
			this->trazeniRacunInput->KeyPress += gcnew System::Windows::Forms::KeyPressEventHandler(this, &MyForm::trazeniRacunInput_KeyPress);
			// 
			// label17
			// 
			...
			this->label17->Size = System::Drawing::Size(178, 22);
			...
			this->pregledRacunaPanel->Location = System::Drawing::Point(227, 50);
			...
			this->PRPbrClanova->Font = (gcnew System::Drawing::Font(L"Montserrat Black", 12, System::Drawing::FontStyle::Bold));
			...
			this->PRPbrClanova->Size = System::Drawing::Size(27, 22);
			...
			this->label41->Font = (gcnew System::Drawing::Font(L"Montserrat", 12, System::Drawing::FontStyle::Bold));
			...
			this->PRPcijenaSaPdv->Font = (gcnew System::Drawing::Font(L"Montserrat Black", 12, System::Drawing::FontStyle::Bold));
			...
			this->PRPcijenaSaPdv->Size = System::Drawing::Size(48, 22);
			...
			this->label38->Font = (gcnew System::Drawing::Font(L"Montserrat Black", 12, System::Drawing::FontStyle::Bold));
			...
			this->label38->Size = System::Drawing::Size(48, 22);
			...
			this->PRPpdv->Font = (gcnew System::Drawing::Font(L"Montserrat Black", 12, System::Drawing::FontStyle::Bold));
			...
			this->PRPpdv->Size = System::Drawing::Size(48, 22);
			...
			this->PRPpdvOsnovica->Font = (gcnew System::Drawing::Font(L"Montserrat Black", 12, System::Drawing::FontStyle::Bold));
			...
			this->PRPpdvOsnovica->Size = System::Drawing::Size(48, 22);
			...
			this->PRPcijenaBezPdv->Font = (gcnew System::Drawing::Font(L"Montserrat Black", 12, System::Drawing::FontStyle::Bold));
			...
			this->PRPcijenaBezPdv->Size = System::Drawing::Size(48, 22);
			...
			this->PRPodvozSmeca->Font = (gcnew System::Drawing::Font(L"Montserrat Black", 12, System::Drawing::FontStyle::Bold));
			...
			this->PRPodvozSmeca->Size = System::Drawing::Size(48, 22);
			...
			this->PRPpvnIsporucenaVoda->Font = (gcnew System::Drawing::Font(L"Montserrat Black", 12, System::Drawing::FontStyle::Bold));
			...
			this->PRPpvnIsporucenaVoda->Size = System::Drawing::Size(48, 22);
			...
			this->PRPpvnZastitaVoda->Font = (gcnew System::Drawing::Font(L"Montserrat Black", 12, System::Drawing::FontStyle::Bold));
			...
			this->PRPpvnZastitaVoda->Size = System::Drawing::Size(48, 22);
			...
			this->PRPfiksniTrosakDom->Font = (gcnew System::Drawing::Font(L"Montserrat Black", 12, System::Drawing::FontStyle::Bold));
			...
			this->PRPfiksniTrosakDom->Size = System::Drawing::Size(48, 22);
			...
			this->PRPodrzavanjeKanSis->Font = (gcnew System::Drawing::Font(L"Montserrat Black", 12, System::Drawing::FontStyle::Bold));
			...
			this->PRPodrzavanjeKanSis->Size = System::Drawing::Size(48, 22);
			...
			this->PRPcijenaVode->Font = (gcnew System::Drawing::Font(L"Montserrat Black", 12, System::Drawing::FontStyle::Bold));
			...
			this->PRPcijenaVode->Size = System::Drawing::Size(48, 22);
			...
			this->label28->Font = (gcnew System::Drawing::Font(L"Montserrat", 12, System::Drawing::FontStyle::Bold));
			...
			this->label28->Size = System::Drawing::Size(123, 22);
			...
			this->label27->Font = (gcnew System::Drawing::Font(L"Montserrat", 12, System::Drawing::FontStyle::Bold));
			...
			this->label27->Size = System::Drawing::Size(156, 22);
			...
			this->label26->Font = (gcnew System::Drawing::Font(L"Montserrat", 12, System::Drawing::FontStyle::Bold));
			...
			this->label25->Font = (gcnew System::Drawing::Font(L"Montserrat", 12, System::Drawing::FontStyle::Bold));
			...
			this->label24->Font = (gcnew System::Drawing::Font(L"Montserrat", 12, System::Drawing::FontStyle::Bold));
			...
			this->label24->Size = System::Drawing::Size(174, 22);
			...
			this->label23->Font = (gcnew System::Drawing::Font(L"Montserrat", 12, System::Drawing::FontStyle::Bold));
			...
			this->label23->Size = System::Drawing::Size(139, 22);
			...
			this->label22->Font = (gcnew System::Drawing::Font(L"Montserrat", 12, System::Drawing::FontStyle::Bold));
			...
			this->label22->Size = System::Drawing::Size(252, 22);
			...
			this->label21->Font = (gcnew System::Drawing::Font(L"Montserrat", 12, System::Drawing::FontStyle::Bold));
			...
			this->label21->Size = System::Drawing::Size(294, 22);
			...
			this->label20->Font = (gcnew System::Drawing::Font(L"Montserrat", 12, System::Drawing::FontStyle::Bold));
			...
			this->label20->Size = System::Drawing::Size(275, 22);
			...
			this->label19->Font = (gcnew System::Drawing::Font(L"Montserrat", 12, System::Drawing::FontStyle::Bold));
			...
			this->label19->Size = System::Drawing::Size(371, 22);
			...
			this->label18->Font = (gcnew System::Drawing::Font(L"Montserrat", 12, System::Drawing::FontStyle::Bold));
			...
			this->label18->Size = System::Drawing::Size(196, 22);
			...
			this->label16->Font = (gcnew System::Drawing::Font(L"Montserrat", 12, System::Drawing::FontStyle::Bold));
			...
			this->label16->Size = System::Drawing::Size(98, 22);
			...
			this->label14->Font = (gcnew System::Drawing::Font(L"Montserrat", 12, System::Drawing::FontStyle::Bold));
			...
			this->PRPrazlikaStanja->Font = (gcnew System::Drawing::Font(L"Montserrat Black", 12, System::Drawing::FontStyle::Bold));
			...
			this->PRPrazlikaStanja->Size = System::Drawing::Size(104, 22);
			...
			this->label11->Font = (gcnew System::Drawing::Font(L"Montserrat", 12, System::Drawing::FontStyle::Bold));
			...
			this->label11->Size = System::Drawing::Size(96, 22);
			...
			this->PRPnovoStanje->Font = (gcnew System::Drawing::Font(L"Montserrat Black", 12, System::Drawing::FontStyle::Bold));
			...
			this->PRPnovoStanje->Size = System::Drawing::Size(104, 22);
			...
			this->label12->Font = (gcnew System::Drawing::Font(L"Montserrat", 12, System::Drawing::FontStyle::Bold));
			...
			this->PRPstaroStanje->Font = (gcnew System::Drawing::Font(L"Montserrat Black", 12, System::Drawing::FontStyle::Bold));
			...
			this->PRPstaroStanje->Size = System::Drawing::Size(104, 22);
			...
			this->label10->Font = (gcnew System::Drawing::Font(L"Montserrat", 12, System::Drawing::FontStyle::Bold));
			...
			this->PRPmjestoIzdavanja->Font = (gcnew System::Drawing::Font(L"Montserrat Black", 12, System::Drawing::FontStyle::Bold));
			...
			this->PRPmjestoIzdavanja->Size = System::Drawing::Size(67, 22);
			...
			this->label9->Font = (gcnew System::Drawing::Font(L"Montserrat", 12, System::Drawing::FontStyle::Bold));
			...
			this->PRPperiod->Font = (gcnew System::Drawing::Font(L"Montserrat Black", 12, System::Drawing::FontStyle::Bold));
			...
			this->PRPperiod->Size = System::Drawing::Size(235, 22);
			...
			this->label8->Font = (gcnew System::Drawing::Font(L"Montserrat", 12, System::Drawing::FontStyle::Bold));
			...
			this->PRPbrRacuna->Font = (gcnew System::Drawing::Font(L"Montserrat Black", 12, System::Drawing::FontStyle::Bold));
			...
			this->PRPbrRacuna->Size = System::Drawing::Size(112, 22);
			...
			this->label6->Font = (gcnew System::Drawing::Font(L"Montserrat", 12, System::Drawing::FontStyle::Bold));
			...
			this->label7->Font = (gcnew System::Drawing::Font(L"Montserrat", 12, System::Drawing::FontStyle::Bold));
			this->label7->ForeColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(64)), static_cast<System::Int32>(static_cast<System::Byte>(64)),
				static_cast<System::Int32>(static_cast<System::Byte>(64)));
			this->label7->Location = System::Drawing::Point(168, 90);
			this->label7->Name = L"label7";
			this->label7->Size = System::Drawing::Size(613, 22);
			...
			this->label5->Font = (gcnew System::Drawing::Font(L"Montserrat", 12, System::Drawing::FontStyle::Bold));
			this->label5->ForeColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(64)), static_cast<System::Int32>(static_cast<System::Byte>(64)),
				static_cast<System::Int32>(static_cast<System::Byte>(64)));
			this->label5->Location = System::Drawing::Point(170, 72);
			this->label5->Name = L"label5";
			this->label5->Size = System::Drawing::Size(533, 22);
			...
			this->label4->Font = (gcnew System::Drawing::Font(L"Montserrat", 12, System::Drawing::FontStyle::Bold));
			this->label4->ForeColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(64)), static_cast<System::Int32>(static_cast<System::Byte>(64)),
				static_cast<System::Int32>(static_cast<System::Byte>(64)));
			this->label4->Location = System::Drawing::Point(169, 54);
			this->label4->Name = L"label4";
			this->label4->Size = System::Drawing::Size(506, 22);
			...
			this->label3->Font = (gcnew System::Drawing::Font(L"Montserrat", 12, System::Drawing::FontStyle::Bold));
			...
			this->label3->Size = System::Drawing::Size(750, 22);
			...
			this->label2->Font = (gcnew System::Drawing::Font(L"Montserrat", 12, System::Drawing::FontStyle::Bold));
			this->label2->ForeColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(64)), static_cast<System::Int32>(static_cast<System::Byte>(64)),
				static_cast<System::Int32>(static_cast<System::Byte>(64)));
			this->label2->Location = System::Drawing::Point(170, 16);
			this->label2->Name = L"label2";
			this->label2->Size = System::Drawing::Size(769, 22);
			...
			this->pictureBox8->Location = System::Drawing::Point(61, 26);
			...
			this->potrosacBox->Font = (gcnew System::Drawing::Font(L"Montserrat", 12, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			...
			this->PRPmjesto->Font = (gcnew System::Drawing::Font(L"Montserrat Black", 12, System::Drawing::FontStyle::Bold));
			this->PRPmjesto->Location = System::Drawing::Point(151, 67);
			this->PRPmjesto->Name = L"PRPmjesto";
			this->PRPmjesto->Size = System::Drawing::Size(67, 22);
			...
			this->PRPpostanski->Font = (gcnew System::Drawing::Font(L"Montserrat Black", 12, System::Drawing::FontStyle::Bold));
			this->PRPpostanski->Location = System::Drawing::Point(88, 67);
			this->PRPpostanski->Name = L"PRPpostanski";
			this->PRPpostanski->Size = System::Drawing::Size(63, 22);
			...
			this->label1->Font = (gcnew System::Drawing::Font(L"Montserrat", 12, System::Drawing::FontStyle::Bold));
			...
			this->PRPadresa->Font = (gcnew System::Drawing::Font(L"Montserrat Black", 12, System::Drawing::FontStyle::Bold));
			this->PRPadresa->Location = System::Drawing::Point(88, 44);
			this->PRPadresa->Name = L"PRPadresa";
			this->PRPadresa->Size = System::Drawing::Size(231, 22);
			...
			this->label15->Font = (gcnew System::Drawing::Font(L"Montserrat", 12, System::Drawing::FontStyle::Bold));
			this->label15->Location = System::Drawing::Point(7, 44);
			this->label15->Name = L"label15";
			this->label15->Size = System::Drawing::Size(74, 22);
			...
			this->PRPimePrezime->Font = (gcnew System::Drawing::Font(L"Montserrat Black", 12, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->PRPimePrezime->Location = System::Drawing::Point(7, 22);
			this->PRPimePrezime->Name = L"PRPimePrezime";
			this->PRPimePrezime->Size = System::Drawing::Size(176, 22);
			this->PRPimePrezime->TabIndex = 0;
			this->PRPimePrezime->Text = L"Ime (Otac) Prezime";
			// 
			// groupBox1
			// 
			this->groupBox1->Font = (gcnew System::Drawing::Font(L"Montserrat", 12, System::Drawing::FontStyle::Bold));
			...
			// greskaLabel
			// 
			this->greskaLabel->Font = (gcnew System::Drawing::Font(L"Montserrat", 14.25F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->greskaLabel->ForeColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(192)), static_cast<System::Int32>(static_cast<System::Byte>(0)),
				static_cast<System::Int32>(static_cast<System::Byte>(0)));
			this->greskaLabel->Image = (cli::safe_cast<System::Drawing::Image^>(resources->GetObject(L"greskaLabel.Image")));
			this->greskaLabel->ImageAlign = System::Drawing::ContentAlignment::MiddleLeft;
			this->greskaLabel->Location = System::Drawing::Point(424, 66);
			this->greskaLabel->Margin = System::Windows::Forms::Padding(10, 0, 3, 0);
			this->greskaLabel->Name = L"greskaLabel";
			this->greskaLabel->Size = System::Drawing::Size(601, 47);
			this->greskaLabel->TabIndex = 49;
			this->greskaLabel->Text = L"SVA POLJA MORAJU BITI POPUNJENA !";
			this->greskaLabel->TextAlign = System::Drawing::ContentAlignment::MiddleCenter;
			this->greskaLabel->Visible = false;
			// 
			// MyForm
			// 
			...
			this->Controls->Add(this->greskaLabel);
...
#pragma endregion
	...
	private: System::Void ispisiRacunBtn_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		if (imeInput->Text == "" || prezimeInput->Text == "" || imeOcaInput->Text == "" || adresaInput->Text == "" || postanskiBrInput->Text == "" || brClanovaInput->Text == "" || staroStanjeInput->Text == "" || novoStanjeInput->Text == "") {
			greskaLabel->Text = "SVA POLJA MORAJU BITI POPUNJENA !";
			greskaLabel->Visible = true;
		}
		else {
			greskaLabel->Visible = false;
	...
	private: System::Void pregledRacuna_Click(System::Object^ sender, System::EventArgs^ e) {

		if (trazeniRacunInput->Text == "") {
			greskaLabel->Text = "POLJE JE PRAZNO ILI RACUN NIJE PRONADJEN !";
			greskaLabel->Visible = true;
		}
		else {
	...
	private: System::Void trazeniRacunInput_KeyPress(System::Object^ sender, System::Windows::Forms::KeyPressEventArgs^ e) {
		char ch = e->KeyChar;
		trazeniRacunInput->MaxLength = 8;
		if (!isdigit(ch) && !iscntrl(ch))
		{
			e->Handled = true;
		}
